...
<table width="200" border="0" align="center">
  <tr align="center">
    <!-- 链接有问题 -->
    <td><input type="button" value="修改" onclick="window.location.href='__URL__/WenjianModification/id/<?php echo ($data['FILE_ID']); ?>'"></td>
...
<table width="200" border="0" align="center">
  <tr align="center">
    <td><a href="__URL__/FilesModification">修改</a></td>
    <td><a href="__URL__/FileList">返回</a></td>
  </tr>
</table></form>
<p>&nbsp;</p>
</body>
