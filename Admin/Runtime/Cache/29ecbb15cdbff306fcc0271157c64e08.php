...
<form><table width="470" border="0" align="center" cellspacing="1" bgcolor="#000000">
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" width="130"><?php if(($data['IS_PUBLIC'] == 0) ): ?>不公开 <?php else: ?>公开<?php endif; ?>
  </tr>
  <tr>
...
<table width="366" border="0" align="center">
  <tr align="center">
    <td><input type="button" value="修改" onclick="window.location.href='__URL__/FileModification/id/<?php echo ($data['SEQID']); ?>'"></td>
