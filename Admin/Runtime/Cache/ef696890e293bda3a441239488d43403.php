...
<form action="__URL__/FileSave" method="post" name="filedForm" onsubmit ="return check(this);">
...
<input type="hidden" name="ids" value="<?php echo ($data['SEQID']); ?>">
    <table width="200" border="0" align="center">
      <tr align="center">
        ...
        <td><input type="button" value="返回" onclick="window.location.href='__URL__/FilesInformation/id/<?php echo ($data['SEQID']); ?>'"></td>
      </tr>
    </table>
</form>
</body>
