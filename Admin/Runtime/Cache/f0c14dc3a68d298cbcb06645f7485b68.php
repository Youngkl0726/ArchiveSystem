...
<body>
<form>
<table width="470" border="0" align="center" cellspacing="1" bgcolor="#000000">
  <tr>
    <td width="100" bgcolor="#999999">模版编号</td>
    <td width="370" colspan="3" bgcolor="#CCCCCC"><?php echo ($data['TEMPLATE_NUM']); ?></td>
  </tr>
  <tr>
    <td width="100" bgcolor="#999999">模版名称</td>
    <td width="370" colspan="3" bgcolor="#CCCCCC"><?php echo ($data['TEMPLATE_NAME']); ?></td>
  </tr>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" width="130"></td><?php if(($data['IS_PUBLIC'] == 0) ): ?>不公开 <?php else: ?>公开<?php endif; ?>
  </tr>
  <tr>
...
<table width="366" border="0" align="center">
  <tr align="center">
   <!--  <td><input type="button" value="修改" onclick="window.location.href='__URL__/TemplateFilesModification'">
      <a href="__URL__/TemplateFilesModification">修改</a></td>
     -->
