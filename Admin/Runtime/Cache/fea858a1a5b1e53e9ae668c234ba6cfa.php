...
<form name="fileForm" method="post" action="<?php echo U('/PRM/wenjianadd');?>">
  ...
  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      <input type="hidden" name="FILE_CODE" value="<?php echo ($vo["FILE_CODE"]); ?>">
...
<td>
    ...
    <td><input type="button" value="返回" onclick="window.location.href='__URL__/FilesInformation2/id/<?php echo ($id); ?>'"></td>
</form></div>
</body>
</html>